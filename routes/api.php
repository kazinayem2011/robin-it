...
Route::middleware(['web', 'auth', 'admin', 'throttle:api'])
    ...
    ->group(function () {
        ...
        Route::patch(ApiEndpoints::ADMIN_CATEGORIES_MOVE, [AdminCategoryController::class, 'move'])->middleware('can:catalogue');
        ...
        /*
         * Changing an order after it is placed. Stock is already reserved
