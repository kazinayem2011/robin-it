 ...
 *
 * Carried over from FormSelect, the native control this replaced, which had
 * the fault this guards: it did not declare the prop, so a hint passed to it
 * was spread onto the <select> and React dropped it as an unknown attribute.
 * The first screen to pass one — the delivery form, saying that the
 * opening-balance source is not a purchase — printed nothing.
 */
