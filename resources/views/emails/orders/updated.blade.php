...
@extends('emails.layouts.master', [
    'title' => 'Order #'.$order->order_number.' was updated',
    'preheader' => 'Order #'.$order->order_number.' now comes to ৳'.number_format($order->total, 2).' — here is what it holds.',
])
...
@section('content')
    ...
    <p class="eml-muted" style="margin:0 0 26px; font-family:Arial,Helvetica,sans-serif; font-size:15px; line-height:24px; color:#475569;">
        We've changed the items on order #{{ $order->order_number }}. This is what it holds now, and what to pay on delivery.
    </p>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0 0 26px;">
        ...
        {{-- What they were told before, so the change is plain without digging out the first email. --}}
        <tr>
            <td align="right" style="padding:8px 0 0; font-family:Arial,Helvetica,sans-serif; font-size:13px; color:#64748b;">Was</td>
            <td align="right" style="padding:8px 0 0; font-family:Arial,Helvetica,sans-serif; font-size:13px; color:#64748b; white-space:nowrap; text-decoration:line-through;">৳{{ number_format($totalBefore, 2) }}</td>
        </tr>
    </table>
        ...
        <tr>
            <td align="center" style="padding:0 0 24px;">
                ...
                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"
                             href="{{ $order->trackUrl() }}" style="height:46px;v-text-anchor:middle;width:260px;" arcsize="13%" stroke="f" fillcolor="#d12127">
                    <w:anchorlock/>
                    <center style="color:#ffffff;font-family:Arial,sans-serif;font-size:15px;font-weight:bold;">Track your order</center>
                </v:roundrect>
                <![endif]-->
                <!--[if !mso]><!-- -->
                <a href="{{ $order->trackUrl() }}"
    ...
    <p class="eml-muted" style="margin:0; font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:21px; color:#64748b; text-align:center;">
        Not what you expected? Reply to this email or call
