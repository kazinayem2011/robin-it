...
@extends('emails.layouts.master', [
    ...
    'preheader' => 'Confirm this address so we can send order updates and delivery notices to it.',
])
...
@section('content')
    ...
    {{-- Some clients strip the button, and some people will not click one on
         principle. The address is worth spelling out either way. --}}
    ...
    <p class="eml-muted" style="margin:0; font-family:Arial,Helvetica,sans-serif; font-size:13px; line-height:21px; color:#64748b; text-align:center;">
        The link expires in {{ $expiresInMinutes }} minutes. If you did not create
        an account, nothing happens — you can ignore this message.
    </p>
@endsection
